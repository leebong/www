...
<body>
   ...
   <tr>
	...
	<tr>
		...
		<hr size=1>
		<div align="center">
		[ <input type="button" value="목록" onclick="move('./Board_List');"> | 
		<input type="button" value="수정" onclick="move('./Board_Update');"> |
		<input type="button" value="답변" onclick="move('./Board_Reply');"> |
		<input type="button" value="삭제" onclick="move('./Board_Delete');">]<br>
		</div>
		</td>
	</tr>
	</table>
